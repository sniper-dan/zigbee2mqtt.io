...
## Notes
Pairing #
Remove the battery then reinsert with the reset button held down until the light flashes blue. After this the device will automatically join. If the light flashes orange, remove the battery and try again.
